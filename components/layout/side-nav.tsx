...
export function SideNav({ navItems }: { navItems: NavItem[] }) {
  return (
    <aside className="flex w-full shrink-0 flex-col border-b border-[var(--line-subtle)] bg-[var(--bg-panel)] p-3 lg:h-full lg:w-[284px] lg:border-r lg:border-b-0 lg:overflow-auto">
      ...
      <div className="mt-auto rounded-xl border border-[var(--line-subtle)] bg-[#02070d] p-3">
